        ...
        <div class="container-fluid page-body-wrapper">
            ...
            <nav class="sidebar sidebar-offcanvas" id="sidebar">
                <ul class="nav">
                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse" id="ui-basic">
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item"><a class="nav-link" href="{{ route('master.order') }}">Order</a>
                                </li>
                                <li class="nav-item"><a class="nav-link"
                                        href="{{ route('master.customer') }}">Customer</a></li>
                                <li class="nav-item"><a class="nav-link" href="{{ route('master.uom') }}">UOM</a>
                                </li>
                                <li class="nav-item"><a class="nav-link" href="{{ route('master.User') }}">User</a>
                                </li>
                                <li class="nav-item"><a class="nav-link" href="{{ route('master.belt') }}">Belt</a>
                                </li>
                            </ul>
                        </div>
                    </li>
                    ...
                    <li
                        class="nav-item {{ Illuminate\Support\Facades\Route::currentRouteName() == 'report' ? 'active' : '' }}">
                    ...
                    <li
                        class="nav-item {{ Illuminate\Support\Facades\Route::currentRouteName() == 'users' ? 'active' : '' }}">
